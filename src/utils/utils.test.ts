...
describe('useChartDataAttributes', () => {
    ...
    it('should handle empty legend names array', () => {
        ...
        expect(() => {
            renderHook(() =>
                useChartDataAttributes(mockRef, [], mockHiddenSeries, mockRenderKey)
            );
        }).not.toThrow();
    });
    ...
    it('should handle hidden series', () => {
        ...
        expect(() => {
            renderHook(() =>
                useChartDataAttributes(mockRef, mockLegendNames, hiddenSeries, mockRenderKey)
            );
        }).not.toThrow();
    });
    ...
    it('should handle series with no datapoints', () => {
        ...
        expect(() => {
            renderHook(() =>
                useChartDataAttributes(mockRef, legendNamesWithEmpty, mockHiddenSeries, mockRenderKey)
            );
        }).not.toThrow();
    });
