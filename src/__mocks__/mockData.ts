...
export const MOCK_RHEL_DATA_BY_NAME = [
  RHEL_NINE_TWO,
  RHEL_NINE,
  RHEL_EIGHT_SEVEN,
  RHEL_EIGHT_THREE,
...
export const MOCK_RHEL_DATA_BY_RELEASE_DATE = [
  RHEL_NINE_TWO,
  RHEL_EIGHT_SEVEN,
  RHEL_NINE,
  RHEL_EIGHT_THREE,
...
export const MOCK_RHEL_DATA_BY_RETIREMENT_DATE = [
  RHEL_NINE,
  RHEL_NINE_TWO,
  RHEL_EIGHT_SEVEN,
  RHEL_EIGHT_THREE,
...
export const MOCK_RHEL_DATA_BY_SYSTEMS = [
  RHEL_EIGHT_THREE,
  RHEL_NINE,
  RHEL_EIGHT_SEVEN,
  RHEL_NINE_TWO,
...
export const MOCK_RHEL_DATA_BY_RELEASE = [
  RHEL_NINE_TWO,
  RHEL_NINE,
  RHEL_EIGHT_SEVEN,
  RHEL_EIGHT_THREE,
