...
const ReleasedTab = lazy(
  () => import('../../Components/Released/released')
);
  ...
  return (
    <React.Fragment>
      <PageHeader>
        ...
        <p>Provides tailored forward-looking roadmap information and tailored information on how RHEL minor and major releases will affect the customers environment</p>
      </PageHeader>
